...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/calphy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14275&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/calphy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `calphy` can be installed with:

```
conda install calphy
```

It is possible to list all of the versions of `calphy` available on your platform with:
